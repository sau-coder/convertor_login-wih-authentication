...
from src.image_converter.conversion.Image_Conversion import Image_Conversion
from src.utils.remove_static_files import remove_files
from src.utils.s3_utils import S3Events


class Image_Conversion_Controller:
    ...
    def upload_file_function(self):
        ...
        """
        file_obj = open(self.output_file, "rb")
        s3 = S3Events()
    ...
    def Image_converter(self):
        """
        This function will act as a controller for image conversion.
        """
        image_conversion_object = Image_Conversion(
            input_file_path=self.input_file,
            output_file_path=self.output_file,
            conversion_type=self.conversion_type,
            type=self.type,
        )
        image_conversion_object.converter()
