...
from src.file_converter.conversion.File_Conversion import File_Conversion
from src.utils.remove_static_files import remove_files
from src.utils.s3_utils import S3Events


class File_Conversion_Controller:
    ...
    def file_converter(self):
        """
        This function will act as a controller for file conversion.
        """
        file_conversion_object = File_Conversion(
            input_file_path=self.input_file,
            output_file_path=self.output_file,
            conversion_type=self.conversion_type,
            type=self.type,
        )
        file_conversion_object.converter()
